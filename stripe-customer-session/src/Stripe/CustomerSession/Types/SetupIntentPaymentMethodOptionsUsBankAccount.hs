...
-- 
-- 
data Setup_intent_payment_method_options_us_bank_account = Setup_intent_payment_method_options_us_bank_account {
...
instance Data.Aeson.Types.ToJSON.ToJSON Setup_intent_payment_method_options_us_bank_account
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("financial_connections" Data.Aeson.Types.ToJSON..=)) (setup_intent_payment_method_options_us_bank_accountFinancial_connections obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (setup_intent_payment_method_options_us_bank_accountMandate_options obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setup_intent_payment_method_options_us_bank_accountVerification_method obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("financial_connections" Data.Aeson.Types.ToJSON..=)) (setup_intent_payment_method_options_us_bank_accountFinancial_connections obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (setup_intent_payment_method_options_us_bank_accountMandate_options obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setup_intent_payment_method_options_us_bank_accountVerification_method obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON Setup_intent_payment_method_options_us_bank_account
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Setup_intent_payment_method_options_us_bank_account" (\obj -> ((GHC.Base.pure Setup_intent_payment_method_options_us_bank_account GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "financial_connections")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mandate_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
-- | Create a new 'Setup_intent_payment_method_options_us_bank_account' with all required fields.
mkSetup_intent_payment_method_options_us_bank_account :: Setup_intent_payment_method_options_us_bank_account
