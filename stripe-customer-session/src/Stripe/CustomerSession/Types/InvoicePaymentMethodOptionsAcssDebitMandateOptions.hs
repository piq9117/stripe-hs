...
instance Data.Aeson.Types.ToJSON.ToJSON Invoice_payment_method_options_acss_debit_mandate_options
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("transaction_type" Data.Aeson.Types.ToJSON..=)) (invoice_payment_method_options_acss_debit_mandate_optionsTransaction_type obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("transaction_type" Data.Aeson.Types.ToJSON..=)) (invoice_payment_method_options_acss_debit_mandate_optionsTransaction_type obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON Invoice_payment_method_options_acss_debit_mandate_options
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Invoice_payment_method_options_acss_debit_mandate_options" (\obj -> GHC.Base.pure Invoice_payment_method_options_acss_debit_mandate_options GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "transaction_type"))}
