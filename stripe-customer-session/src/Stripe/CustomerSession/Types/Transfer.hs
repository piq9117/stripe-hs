...
data Transfer = Transfer {
  ...
  -- 
  -- * Maximum length of 5000
  , transferSource_type :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
...
data TransferDestination_paymentVariants =
   TransferDestination_paymentText Data.Text.Internal.Text
  | TransferDestination_paymentCharge Charge
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TransferDestination_paymentVariants
    where {toJSON (TransferDestination_paymentText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (TransferDestination_paymentCharge a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON TransferDestination_paymentVariants
    where {parseJSON val = case (TransferDestination_paymentText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((TransferDestination_paymentCharge Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data TransferReversals = TransferReversals {
  ...
  -- 
  -- * Maximum length of 5000
  , transferReversalsUrl :: Data.Text.Internal.Text
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
