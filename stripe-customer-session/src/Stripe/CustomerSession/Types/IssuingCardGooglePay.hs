...
-- 
-- 
data Issuing_card_google_pay = Issuing_card_google_pay {
...
instance Data.Aeson.Types.ToJSON.ToJSON Issuing_card_google_pay
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["eligible" Data.Aeson.Types.ToJSON..= issuing_card_google_payEligible obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ineligible_reason" Data.Aeson.Types.ToJSON..=)) (issuing_card_google_payIneligible_reason obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["eligible" Data.Aeson.Types.ToJSON..= issuing_card_google_payEligible obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ineligible_reason" Data.Aeson.Types.ToJSON..=)) (issuing_card_google_payIneligible_reason obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON Issuing_card_google_pay
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Issuing_card_google_pay" (\obj -> (GHC.Base.pure Issuing_card_google_pay GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "eligible")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ineligible_reason"))}
-- | Create a new 'Issuing_card_google_pay' with all required fields.
mkIssuing_card_google_pay :: GHC.Types.Bool -- ^ 'issuing_card_google_payEligible'
