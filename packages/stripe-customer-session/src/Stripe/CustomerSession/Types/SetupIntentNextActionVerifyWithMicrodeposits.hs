...
-- 
-- 
data Setup_intent_next_action_verify_with_microdeposits = Setup_intent_next_action_verify_with_microdeposits {
  -- | arrival_date: The timestamp when the microdeposits are expected to land.
  setup_intent_next_action_verify_with_microdepositsArrival_date :: GHC.Types.Int
...
instance Data.Aeson.Types.ToJSON.ToJSON Setup_intent_next_action_verify_with_microdeposits
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["arrival_date" Data.Aeson.Types.ToJSON..= setup_intent_next_action_verify_with_microdepositsArrival_date obj] : ["hosted_verification_url" Data.Aeson.Types.ToJSON..= setup_intent_next_action_verify_with_microdepositsHosted_verification_url obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("microdeposit_type" Data.Aeson.Types.ToJSON..=)) (setup_intent_next_action_verify_with_microdepositsMicrodeposit_type obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["arrival_date" Data.Aeson.Types.ToJSON..= setup_intent_next_action_verify_with_microdepositsArrival_date obj] : ["hosted_verification_url" Data.Aeson.Types.ToJSON..= setup_intent_next_action_verify_with_microdepositsHosted_verification_url obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("microdeposit_type" Data.Aeson.Types.ToJSON..=)) (setup_intent_next_action_verify_with_microdepositsMicrodeposit_type obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON Setup_intent_next_action_verify_with_microdeposits
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Setup_intent_next_action_verify_with_microdeposits" (\obj -> ((GHC.Base.pure Setup_intent_next_action_verify_with_microdeposits GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "arrival_date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "hosted_verification_url")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "microdeposit_type"))}
-- | Create a new 'Setup_intent_next_action_verify_with_microdeposits' with all required fields.
mkSetup_intent_next_action_verify_with_microdeposits :: GHC.Types.Int -- ^ 'setup_intent_next_action_verify_with_microdepositsArrival_date'
  -> Data.Text.Internal.Text -- ^ 'setup_intent_next_action_verify_with_microdepositsHosted_verification_url'
