...
instance Data.Aeson.Types.ToJSON.ToJSON Issuing_cardholder_card_issuing
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("user_terms_acceptance" Data.Aeson.Types.ToJSON..=)) (issuing_cardholder_card_issuingUser_terms_acceptance obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("user_terms_acceptance" Data.Aeson.Types.ToJSON..=)) (issuing_cardholder_card_issuingUser_terms_acceptance obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON Issuing_cardholder_card_issuing
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Issuing_cardholder_card_issuing" (\obj -> GHC.Base.pure Issuing_cardholder_card_issuing GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "user_terms_acceptance"))}
-- | Create a new 'Issuing_cardholder_card_issuing' with all required fields.
mkIssuing_cardholder_card_issuing :: Issuing_cardholder_card_issuing
mkIssuing_cardholder_card_issuing = Issuing_cardholder_card_issuing{issuing_cardholder_card_issuingUser_terms_acceptance = GHC.Maybe.Nothing}
