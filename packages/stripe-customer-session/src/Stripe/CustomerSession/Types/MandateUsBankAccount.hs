...
instance Data.Aeson.Types.ToJSON.ToJSON Mandate_us_bank_account
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("collection_method" Data.Aeson.Types.ToJSON..=)) (mandate_us_bank_accountCollection_method obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("collection_method" Data.Aeson.Types.ToJSON..=)) (mandate_us_bank_accountCollection_method obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON Mandate_us_bank_account
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Mandate_us_bank_account" (\obj -> GHC.Base.pure Mandate_us_bank_account GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "collection_method"))}
